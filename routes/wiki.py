...
async def create_page(
    ...
    return await wiki_service.create_page(title, content, author, safe_category, safe_tags)
...
async def update_page(
    ...
    """Update a wiki page"""
    wiki_service = get_wiki_service()
    safe_comment = comment if comment is not None else ""
    return await wiki_service.update_page(page_id, content, editor, safe_comment)
