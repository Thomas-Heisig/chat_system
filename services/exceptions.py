...
class ServiceException(Exception):
    ...
    def __init__(
        self, message: str = "An internal error occurred", details: Optional[Dict[str, Any]] = None
    ):
...
class ValidationError(ServiceException):
    ...
    def __init__(
        self, message: str = "Validation failed", field_errors: Optional[Dict[str, str]] = None
    ):
...
class ExternalAIUnavailableError(ExternalServiceError):
    ...
    def __init__(self, service_name: str = None):
        message = (
            ...
            if service_name
            else "AI service is unavailable"
        )
