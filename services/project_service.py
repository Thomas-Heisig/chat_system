...
from database.repositories import ProjectRepository, UserRepository, TicketRepository, MessageRepository
from database.models import Project, ProjectStatus, ProjectFilter, Ticket, User, PaginatedResponse, TicketFilter, MessageFilter
...
class ProjectService:
    ...
    def get_projects(self, filters: Optional[ProjectFilter] = None) -> PaginatedResponse:
        ...
        try:
            ...
            return PaginatedResponse(items=[], total=0, page=1, page_size=filters.limit if filters else 50, total_pages=0)
    ...
    MessageFilter(project_id=project_id, limit=1000)
            ...
            recent_messages = len([m for m in messages.items 
