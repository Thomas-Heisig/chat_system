        ...
        try:
            async with httpx.AsyncClient(timeout=self.timeout) as client:
                ...
                if response.status_code == 200:
                    ...
                    enhanced_logger.error("Ollama API error", extra={'status': response.status_code})
                    return ""
        except Exception as e:
...
class AIService:
    ...
    async def initialize(self):
        ...
        if await ollama.check_availability():
            ...
            enhanced_logger.info("Ollama provider initialized", extra={'models': await ollama.get_models()})
        
        self._initialized = True
        enhanced_logger.info("AI Service initialized", extra={
