...
class SettingsService:
    ...
    def __init__(self, settings_file: str = "settings.json"):
        ...
        enhanced_logger.info("SettingsService initialized", 
    ...
    def set(self, category: str, key: str, value: Any) -> bool:
        ...
        try:
            ...
            enhanced_logger.info("Setting updated",
                               category=category,
                               key=key,
                               old_value=old_value,
                               new_value=value)
    ...
    def update_category(self, category: str, values: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            enhanced_logger.info("Category settings updated",
                               category=category,
    ...
    def get_database_settings(self) -> Dict[str, Any]:
        ...
        return self.get_category("database")
    ...
    def get_feature_settings(self) -> Dict[str, Any]:
        """Get feature flags"""
        return self.get_category("features")
