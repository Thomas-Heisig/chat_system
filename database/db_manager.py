...
class DatabaseManager:
    ...
    async def migrate(self, target_version: int = None) -> Dict[str, Any]:
        """
    ...
    async def backup(self, backup_path: str = None, prefix: str = None) -> str:
        """
        ...
        if backup_path is None:
            backup_path = self.backup_path / f"{prefix_str}chat_backup_{timestamp}.db.gz"
